CREATE TABLE [sqlmesh__hook].[hook__frame__northwind__order_details__2368013800] (

	[_pit_hook__order__product__id] varchar(max) NULL, 
	[hook__order__id] varchar(max) NULL, 
	[hook__product__id] varchar(max) NULL, 
	[hook__order__product__id] varchar(max) NULL, 
